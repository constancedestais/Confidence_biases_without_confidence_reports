...
def plot_pcorrect_valence_LT(df_mean_per_participant):
    ...
    fig, ax = raincloud_paired_two_conditions(
        data_list,
        my_colors=(c["medium_green"], c["medium_red"]), #my_colors=(c["medium_turquoise"], c["medium_purple"]), #my_colors=("forestgreen", "indianred"),
        reference_value=50.0,
        # axis labels & ticks
        y_limits=(0, None),
        x_tick_labels=("Gain", "Loss"),
