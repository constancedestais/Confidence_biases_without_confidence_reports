...
def plot_chose_gain_pair_CFC_for_heterogeneous_vs_homogeneous_valence_pairs(CFC_mean_per_participant_by_pair_valence_composition):
    '''
    ...
    assert CFC_mean_per_participant_by_pair_valence_composition[0].max() > 1.5, f"Error: chose_highest_expected_value values look like they are still coded 0-1" 
    assert CFC_mean_per_participant_by_pair_valence_composition[1].max() > 1.5, f"Error: chose_highest_expected_value values look like they are still coded 0-1"

    c = load_my_colors() 

    # make plot: CFC_chose_highest_expected_value by pair_valence_composition
